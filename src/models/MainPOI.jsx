	...
	return (
		<group ref={group} {...props} dispose={null}>
			<group name="Scene">
				...
				>
					<group
						name="32669533cadb4077bd473105ce7711cdfbx"
						rotation={[Math.PI / 2, 0, 0]}
						scale={0.01}
					>
						<group name="RootNode">
							...
							>
								<mesh
									name="box_low_defolt_0"
									castShadow
									receiveShadow
									geometry={nodes.box_low_defolt_0.geometry}
									material={materials["defolt.003"]}
									position={[24.015, 623.111, -1.091]}
								/>
							</group>
							<group
								name="doska1_low"
							...
							>
								<mesh
									name="doska1_low_defolt_0"
									castShadow
									receiveShadow
									geometry={nodes.doska1_low_defolt_0.geometry}
									material={materials["defolt.003"]}
									position={[-39.985, -15.889, -1.091]}
								/>
							</group>
							<group
								name="doska2_low"
							...
							>
								<mesh
									name="flag_low_defolt_0"
									castShadow
									receiveShadow
									geometry={nodes.flag_low_defolt_0.geometry}
									material={materials["defolt.003"]}
									position={[-19.985, 248.736, -1.091]}
								/>
							</group>
							<group
								name="grib1_low"
								...
								scale={0}
							/>
							<group name="grib2_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="grib2_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group
								name="mail_low"
								position={[6.502, 161.842, 94.705]}
								rotation={[-1.57, 0.643, 1.56]}
							>
								<mesh
									name="mail_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="mailbox_uv_low" scale={0.01}>
								<group
									name="grass_low001"
									position={[-0.001, 0, 0.004]}
									rotation={[-Math.PI, 0.876, -Math.PI]}
								>
									<mesh
										name="grass_low001_Material_0"
										castShadow
										receiveShadow
										geometry={nodes.grass_low001_Material_0.geometry}
										material={materials["Material.004"]}
										position={[0.035, 0, 0.031]}
									/>
								</group>
								<group name="mail_low003" position={[-0.001, 0, 0.004]}>
									<mesh
										name="mail_low003_defolt_0"
										castShadow
										receiveShadow
								...
								<group name="wood_low001" position={[-0.001, 0, 0.004]} />
							</group>
							<group name="mash2_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="mash2_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="mash3_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="mash3_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="mash4_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="mash4_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="mash5_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="mash5_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="mash_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="mash_low_defolt_0"
									castShadow
									receiveShadow
							...
							<group name="stolb_low" rotation={[-Math.PI / 2, 0, 0]} scale={0}>
								<mesh
									name="stolb_low_defolt_0"
									castShadow
									receiveShadow
