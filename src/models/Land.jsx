...
import { useGLTF, useCursor, Html, SpotLight, Text3D } from "@react-three/drei";
...
export default function Land(props) {
	...
	const targetPosition = [44.045, -1, -2.517];
	...
	return (
		<group {...props} dispose={null}>
			...
			{signSelected === "middle" ? (
				<Html position={[44.045, 10, -4]}>All Projects</Html>
			) : null}
			...
			{signSelected === "back-right" ? (
				<Html position={[38.757, 12, 5.412]}>
					Three.js Spotlight Project #2
				</Html>
			) : null}
